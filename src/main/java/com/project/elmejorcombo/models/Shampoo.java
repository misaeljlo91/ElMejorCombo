...
public class Shampoo {
    ...
    @OneToMany(mappedBy = "shampoo", fetch = FetchType.EAGER, orphanRemoval = true)
    private Set<PackProduct> packProducts = new HashSet<>();

    //CONSTRUCTORES
    public Shampoo() { }

    public Shampoo(String code, String name, String description, String url, double price, int stock) {
        this.code = code;
        this.name = name;
